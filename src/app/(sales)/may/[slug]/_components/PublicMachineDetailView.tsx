    ...
    <PublicMachineMediaProvider images={machine.gallery} title={displayName}>
      <div className="container public-detail-page">
        ...
        <div className="detail-hero">
          <PublicMachineGallery title={displayName} />
          <DecisionPanel machine={machine} />
        </div>
        <div className="detail-reading-entry">
          <p className="decision-hook">
            Phần tiếp theo giúp bạn đối chiếu chiếc máy này với nhu cầu và những
            điều còn chưa chắc chắn.
          </p>
          <nav
            className="dossier-navigation"
            aria-label="Nội dung hồ sơ quyết định"
          >
            ...
            <a href="#passport-cong-khai">
              <MachineDetailIcon name="passport" />
              Passport
            </a>
          </nav>
        </div>
